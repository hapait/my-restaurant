...
import com.mcc.restaurant.listener.ListDialogActionListener;
...
public class AppUtility {
    ...
    public static void invokeMessengerBot(Activity activity) {
        try {
            if (isPackageInstalled(activity.getApplicationContext(), "com.facebook.orca")) {
                ...
                activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("fb://messaging/" + 788720331154519l))); // replace id by facebook page id
            } else {
    ...
    public static void openMap(Activity activity){
        Uri gmmIntentUri = Uri.parse("google.streetview:cbll=23.7692886,90.3488054");
    ...
    public long timestampToMilliseconds(String timestamp){
    ...
    public static ArrayList<String>getPriceFromDesc(String description){
